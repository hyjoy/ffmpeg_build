...
--extra-cflags="-marm -march=armv7-a -I$PLATFORM/usr/include -I$VOAACENC_PATH/build/armv7a/include -I$FDK_AAC_PATH/build/armv7a/include -Iexternal_libs/libx264/build/armv7a/include" \
--extra-ldflags="-marm -march=armv7-a -L$VOAACENC_PATH/build/armv7a/lib -L$FDK_AAC_PATH/build/armv7a/lib -Lexternal_libs/libx264/build/armv7a/lib" \
--prefix='/Users/hyjoy/WorkSpace/Study/ffmpeg/ffmpeg-3.3.9/build/armv7a'
